# SHOGUNATE_WATCHTOWER_LIT — the hinomi fire tower actually on fire: a gold
# blaze on the cap ridge above the hanging bell (its whole purpose, fulfilled).
# H ~0.70, ~215 tris.
KIND = "SHOGUNATE_WATCHTOWER_LIT"
...
# The beacon: a stone bowl and gold blaze on the cap ridge.
add_cyl(coll, "STONE", r=0.024, h=0.022, z0=0.626, seg=6)
add_sphere(coll, "GOLD", r=0.030, z=0.674, seg=6, rings=3)
