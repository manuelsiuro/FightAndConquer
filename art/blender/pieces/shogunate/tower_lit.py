# SHOGUNATE_TOWER_LIT — the yagura with its beacon lit: a fire basket under
# the front eave — stone bowl + gold flame on the overhang board. H ~0.52, ~120 tris.
KIND = "SHOGUNATE_TOWER_LIT"
PIECE = "tower_lit"
...
# The beacon: fire basket on the board's front lip, clear of the roof wedge.
add_cyl(coll, "STONE", r=0.026, h=0.024, z0=0.38, seg=6, y=-0.125)
add_sphere(coll, "GOLD", r=0.028, z=0.43, seg=6, rings=3, y=-0.125)
