# VIKINGS_FORTRESS_LIT — the trelleborg with its beacon lit: a gate fire on
# the stave gatehouse roof, gold cone flame over a stone bowl. H ~0.55, ~455 tris.
KIND = "VIKINGS_FORTRESS_LIT"
PIECE = "fortress_lit"
...
# The beacon: gate fire on the gatehouse roof — stone bowl + gold cone flame.
add_cyl(coll, "STONE", r=0.028, h=0.026, z0=0.25, seg=6, y=-0.195)
add_cyl(coll, "GOLD", r=0.024, h=0.06, z0=0.276, seg=6, r_top=0, y=-0.195)
