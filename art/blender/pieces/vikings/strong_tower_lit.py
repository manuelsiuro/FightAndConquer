# VIKINGS_STRONG_TOWER_LIT — the palisade fort with its beacon lit: a fire
# bowl on the core platform before the watch hut, gold cone flame between the
# stakes. H ~0.60, ~245 tris.
KIND = "VIKINGS_STRONG_TOWER_LIT"
...
# The beacon: fire bowl on the core platform before the hut, cone flame.
add_cyl(coll, "STONE", r=0.032, h=0.028, z0=0.33, seg=6, y=-0.085)
add_cyl(coll, "GOLD", r=0.027, h=0.065, z0=0.358, seg=6, r_top=0, y=-0.085)
