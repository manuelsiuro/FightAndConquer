# WATCHTOWER_LIT — the watchtower with its beacon lit: the standing brazier's
# ember becomes a clearly larger blaze (the base keeps its small flame; this
# variant must read as MORE fire at a glance). H ~0.61, ~240 tris.
KIND = "WATCHTOWER_LIT"
...
# Brazier: a wider bowl and a big gold blaze over a small ember.
add_cyl(coll, "STONE", r=0.042, h=0.034, z0=0.484, seg=6)
add_sphere(coll, "GOLD", r=0.040, z=0.548, seg=6, rings=3)
add_sphere(coll, "GOLD", r=0.022, z=0.594, seg=6, rings=3)
